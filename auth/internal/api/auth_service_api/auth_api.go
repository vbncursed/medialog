...
type authService interface {
	Register(ctx context.Context, in models.RegisterInput) (*models.AuthInfo, error)
	Login(ctx context.Context, in models.LoginInput) (*models.AuthInfo, error)
	Refresh(ctx context.Context, in models.RefreshInput) (*models.AuthInfo, error)
