...
2. **Миграции**: Использовать систему миграций (golang-migrate) вместо `initTables()`
3. **Мониторинг**: Добавить метрики (Prometheus) и трейсинг (OpenTelemetry)
4. **Логирование**: Настроить централизованное логирование (ELK, Loki)
